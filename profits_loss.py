...
# Use mode "r" to read file
   ...
   with write.fp_write.open(mode="a", encoding="UTF-8") as file2:
      ...
      if profit_deficit1 > 0:
         file2.writelines(f"\n[PROFIT DEFICIT] DAY: {dayp[0]}, AMOUNT: USD{profit_deficit1}")
      if profit_deficit2 > 0:
         file2.writelines(f"\n[PROFIT DEFICIT] DAY: {dayp[1]}, AMOUNT: USD{profit_deficit2}")
      if profit_deficit3 > 0:
         file2.writelines(f"\n[PROFIT DEFICIT] DAY: {dayp[2]}, AMOUNT: USD{profit_deficit3}")
      if profit_deficit4 > 0:
         file2.writelines(f"\n[PROFIT DEFICIT] DAY: {dayp[3]}, AMOUNT: USD{profit_deficit4}")
      if profit_deficit5 > 0:
         file2.writelines(f"\n[PROFIT DEFICIT] DAY: {dayp[4]}, AMOUNT: USD{profit_deficit5}")
